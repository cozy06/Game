...
class GameStart : JFrame(), KeyListener {
    ...
    private val selectY: List<Int> = listOf(290, 340, 390, 440)
    ...
    override fun paint(g: Graphics) {
        ...
        offscreenGraphics?.drawString("ONLINE", 75, 325)
        offscreenGraphics?.drawString("Factory", 75, 375)
        offscreenGraphics?.drawString("Reinforce", 75, 425)
        offscreenGraphics?.drawString("Back", 75, 475)
        offscreenGraphics?.drawRect(55, selectY[selector], 120, 50)
